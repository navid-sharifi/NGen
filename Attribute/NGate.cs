...
namespace NSharp
{
    public class NGate : ActionFilterAttribute
    {
        ...
        public NGate(string roles = "", string token = "", string failUrl = "/login")
        {
            this.roles = roles;
            this.token = token;
        ...
        {
            var gateService = context.HttpContext.RequestServices.GetService<NGateService>();
